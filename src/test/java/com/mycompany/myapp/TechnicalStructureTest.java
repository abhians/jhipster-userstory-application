...
@AnalyzeClasses(packagesOf = JhipsterUserStoryApplicationApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterUserStoryApplicationApp.class), alwaysTrue())
